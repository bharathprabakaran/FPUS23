...
# Save best three models during training in './saved_models/Orientation_RES8'
checkpoint_callback = ModelCheckpoint(dirpath='../saved_models/Orientation_RES8', monitor='val_loss', save_top_k=3)
...
torch.save(model, '../saved_models/Orientation_RES8/Orientation_RES8.pth')
n_correct = 0
n_samples = 0
