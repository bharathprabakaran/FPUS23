...
SAVE_PATH = '../Plane_34_RETRAINED'
SAVE_PATH_COMPLETE = './PLANE_34_RETRAINED.pth'
...
image_path = '/home/erik/FINAL_CODE/DNN_models/Dataset_Plane/'#'/srv/data/eostrowski/Code/2_IdealClassifier_V1/dataset/'
...
dataset = datasets.ImageFolder(root=image_path, transform=data_tranform) #  orientation_Dataset(image_path) #
...
for images, labels in dataset:
    if labels == 0:
        ...
        clas3+=1
print(f'CLASS 0 : {clas0}, CLASS 1 : {clas1}, CLASS 2 : {clas2}, CLASS 3 : {clas3}')
...
trainer = pl.Trainer(max_epochs=20, min_epochs=7,
